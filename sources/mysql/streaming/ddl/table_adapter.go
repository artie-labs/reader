...
func NewTableAdapter(dbName string, tableCfg *config.MySQLTable, columns []Column, unixTs int64, sqlMode []string) (TableAdapter, error) {
...
func (t TableAdapter) buildParsedColumns() ([]schema.Column, error) {
	...
	for _, col := range t.columns {
		dataType, opts, err := schema.ParseColumnDataType(col.DataType, t.sqlMode)
		if err != nil {
