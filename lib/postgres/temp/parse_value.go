...
func ParseValue(settings typing.Settings, key string, optionalSchema map[string]typing.KindDetails, val interface{}) typing.KindDetails {
	...
	if len(optionalSchema) > 0 {
		...
		if kindDetail, isOk := optionalSchema[key]; isOk {
			...
			if val != nil && (kindDetail.Kind == typing.ETime.Kind || kindDetail.Kind == typing.EDecimal.Kind) {
